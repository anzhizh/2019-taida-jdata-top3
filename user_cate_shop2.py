...
def get_user_feat9(start_date, end_date):
    dump_path = './cache/user_feat9_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)[['user_id', 'type']]
...
def get_user_feat10(start_date, end_date):
    dump_path = './cache/user_feat10_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_user_feat11(start_date, end_date):
    dump_path = './cache/get_user_feat11_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_user_feat12(start_date, end_date):
    dump_path = './cache/get_user_feat12_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_user_feat13(start_date, end_date):
    dump_path = './cache/user_feat13_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_user_feat14(start_date,end_date):
    dump_path = './cache/user_feat14_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_user_feat15(start_date, end_date):
    dump_path = './cache/user_feat15_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
...
def get_cate_feat_1(start_date, end_date):
    dump_path = './cache/cate_feat1_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # cate购买前访问天数
...
def get_cate_feat_2(start_date, end_date):
    dump_path = './cache/cate_feat2_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_cate_feat_3(start_date, end_date):
    dump_path = './cache/cate_feat3_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_cate_feat_4(start_date, end_date):
    dump_path = './cache/cate_feat4_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = None
...
def get_cate_feat_5(start_date, end_date):
    dump_path = './cache/cate_feat5_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_cate_feat_6(start_date, end_date):
    dump_path = './cache/cate_feat6_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['cate', 'action_time', 'type']]
...
def get_cate_feat_7(start_date, end_date):
    dump_path = './cache/cate_feat7_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # 商品购买前访问次数
...
def get_cate_feat_8(start_date, end_date):
    dump_path = './cache/cate_feat8_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)[['cate', 'type']]
...
def get_cate_feat_9(start_date, end_date):
    dump_path = './cache/cate_feat9_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_cate_feat_10(start_date, end_date):
    dump_path = './cache/cate_feat10_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_cate_feat_11(start_date, end_date):
    dump_path = './cache/cate_feat11_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_cate_feat_12(start_date, end_date, n):
    dump_path = './cache/cate_feat12_F12_5_%s_%s_%s.pkl' % (start_date, end_date, n)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['cate', 'action_time', 'type']]
...
def get_cate_feat_13(start_date, end_date):
    dump_path = './cache/cate_feat13_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        n = 7
...
def get_shop_id_feat_1(start_date, end_date):
    dump_path = './cache/shop_id_feat1_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # shop_id购买前访问天数
...
def get_shop_id_feat_2(start_date, end_date):
    dump_path = './cache/shop_id_feat2_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_shop_id_feat_3(start_date, end_date):
    dump_path = './cache/shop_id_feat3_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_shop_id_feat_4(start_date, end_date):
    dump_path = './cache/shop_id_feat4_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = None
...
def get_shop_id_feat_5(start_date, end_date):
    dump_path = './cache/shop_id_feat5_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_shop_id_feat_6(start_date, end_date):
    dump_path = './cache/shop_id_feat6_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['shop_id', 'action_time', 'type']]
...
def get_shop_id_feat_7(start_date, end_date):
    dump_path = './cache/shop_id_feat7_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # 商品购买前访问次数
...
def get_shop_id_feat_8(start_date, end_date):
    dump_path = './cache/shop_id_feat8_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)[['shop_id', 'type']]
...
def get_shop_id_feat_9(start_date, end_date):
    dump_path = './cache/shop_id_feat9_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_shop_id_feat_10(start_date, end_date):
    dump_path = './cache/shop_id_feat10_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_F11_feat_1(start_date, end_date):
    dump_path = './cache/F11_feat1_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # shop_id购买前访问天数
...
def get_F11_feat_2(start_date, end_date):
    dump_path = './cache/F11_feat2_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F11_feat_3(start_date, end_date):
    dump_path = './cache/F11_feat3_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F11_feat_4(start_date, end_date):
    dump_path = './cache/F11_feat4_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = None
...
def get_F11_feat_5(start_date, end_date):
    dump_path = './cache/F11_feat5_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['user_id', 'cate', 'type']]
...
def get_F11_feat_6(start_date, end_date):
    dump_path = './cache/F11_feat6_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['user_id', 'cate', 'action_time', 'type']]
...
def get_F11_feat_7(start_date, end_date):
    dump_path = './cache/F11_feat7_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # 商品购买前访问次数
...
def get_F11_feat_8(start_date, end_date):
    dump_path = './cache/F11_feat8_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)[['user_id', 'cate', 'type']]
...
def get_F11_feat_9(start_date, end_date):
    dump_path = './cache/F11_feat9_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F11_feat_10(start_date, end_date):
    dump_path = './cache/F11_feat10_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_F11_feat_11(start_date, end_date):
    dump_path = './cache/F11_feat11_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_F11_feat_12(start_date, end_date, n):
    dump_path = './cache/F11_feat12_F12_5_%s_%s_%s.pkl' % (start_date, end_date, n)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['user_id', 'cate', 'action_time', 'type']]
...
def get_F11_feat_13(start_date, end_date):
    dump_path = './cache/F11_feat13_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        n = 7
...
def get_F12_feat_1(start_date, end_date):
    dump_path = './cache/F12_feat1_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # shop_id购买前访问天数
...
def get_F12_feat_2(start_date, end_date):
    dump_path = './cache/F12_feat2_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F12_feat_3(start_date, end_date):
    dump_path = './cache/F12_feat3_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F12_feat_4(start_date, end_date):
    dump_path = './cache/F12_feat4_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = None
...
def get_F12_feat_5(start_date, end_date):
    dump_path = './cache/F12_feat5_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['user_id', 'cate', 'shop_id', 'type']]
...
def get_F12_feat_6(start_date, end_date):
    dump_path = './cache/F12_feat6_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        df = get_actions_product(start_date, end_date)[['user_id', 'cate', 'shop_id', 'action_time', 'type']]
...
def get_F12_feat_7(start_date, end_date):
    dump_path = './cache/F12_feat7_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # 商品购买前访问次数
...
def get_F12_feat_8(start_date, end_date):
    dump_path = './cache/F12_feat8_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)[['user_id', 'cate', 'shop_id', 'type']]
...
def get_F12_feat_9(start_date, end_date):
    dump_path = './cache/F12_feat9_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
...
def get_F12_feat_10(start_date, end_date):
    dump_path = './cache/F12_feat10_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def get_labels(start_date, end_date):
    dump_path = './cache/labels_F12_5_%s_%s.pkl' % (start_date, end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        actions = get_actions_product(start_date, end_date)
...
def make_train_set_F12_5(train_start_date, train_end_date, test_start_date, test_end_date, start):
    dump_path = './cache/train_set_F12_5_%s_%s_%s_%s.pkl' % (
    ...
    if os.path.exists(dump_path):
        ...
        # # add user act5
        # start_days = '2018-04-08 00:00:00'
        # train_end_date = '2018-04-09 00:00:00'
        # user_cart_feat1 = get_user_cart_feat1(start_days, train_end_date)
        # user_cart_feat3 = get_user_cart_feat3(start_days, train_end_date)
        # user_cart_feat5 = get_user_cart_feat5(start_days, train_end_date)
        # user_cart_feat7 = get_user_cart_feat7(start_days, train_end_date)
        # user_cart_feat8 = get_user_cart_feat8(start_days, train_end_date)
        # # user_cart_feat9 = get_user_cart_feat9(start_days, train_end_date)
        # # user_cart_feat10 = get_user_cart_feat10(start_days, train_end_date)
        # user_cart_feat11 = get_user_cart_feat11(start_days, train_end_date)
        # user_cart_feat13 = get_user_cart_feat13(start_days, train_end_date)
        # user_cart_feat15 = get_user_cart_feat15(start_days, train_end_date)
        ...
        user cart
        """
        # actions = pd.merge(actions, user_cart_feat1, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat3, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat5, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat7, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat8, how='left', on='user_id')
        # # actions = pd.merge(actions, user_cart_feat9, how='left', on='user_id')
        # # actions = pd.merge(actions, user_cart_feat10, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat11, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat13, how='left', on='user_id')
        # actions = pd.merge(actions, user_cart_feat15, how='left', on=['user_id', 'cate', 'shop_id'])
        actions = actions.fillna(0)
        # actions.to_pickle(dump_path)
...
def make_test_set_F12_5(train_start_date, train_end_date,start):
    dump_path = './cache/test_set_F12_5_%s_%s.pkl' % (train_start_date, train_end_date)
    if os.path.exists(dump_path):
        actions = pd.read_pickle(dump_path)
    else:
        # 索引
        ...
        # # add user act5
        # start_days = '2018-04-15 00:00:00'
        # train_end_date = '2018-04-16 00:00:00'
        # user_cart_feat1 = get_user_cart_feat1(start_days, train_end_date)
        # user_cart_feat3 = get_user_cart_feat3(start_days, train_end_date)
        # user_cart_feat5 = get_user_cart_feat5(start_days, train_end_date)
        # user_cart_feat7 = get_user_cart_feat7(start_days, train_end_date)
...
def lgb_train_F12_5(X_train1, y_train1, X_test1, sub_user_index):
    # 提交结果
    ...
    sub.to_csv('./res/sub_F12_5.csv', index=False, index_label=False)
